...
<div class="et_pb_row row-1">
    <div class="row">
                ...
                <div class="col-md-7 profile-details-container">
                    <div>
                        <div class="profile-details">
                            <h4 class="display-name"><?php echo ucfirst($pro_info->display_name); ?></h4>
        ...
        <div class="col-md-7">
            <p class="claim-account-p"><a class="claim-account" href="javascript:void(0)" pro-id="<?php echo $pro_id; ?>">Own this Professional, Claim Your Account?</a> <strong><a class="view-reviews" href="#"><?php echo $results->total_reviews; ?> Reviews</a></strong></p>
        ...
        <div class="col-md-12" id="<?php echo $results->id; ?>">
            <div class="card p-3 mb-4">
                ...
                <div class="pro-details">
                    <h3 class="heading"><?php echo $results->title; ?></h3>
