...
<div id="wrapper">
    ...
    <aside id="sidebar-wrapper">
        ...
        <li class="active">
            <a href="<?php echo home_url('/professional-reviews-dashboard') ?>"><img src="<?php echo home_url('/wp-content/uploads/2022/06/rating-received.png') ?>" alt=""></a>
        </li>
        <li>
            <a href="<?php echo home_url('/professional-settings') ?>"><img src="<?php echo home_url('/wp-content/uploads/2022/06/setting-nav-icon.png') ?>" alt=""></a>
        </li>
        </ul>
    </aside>
