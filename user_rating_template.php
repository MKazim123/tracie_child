...
<div id="wrapper">
  ...
  <aside id="sidebar-wrapper">
    ...
    <ul class="sidebar-nav">
      <li class="active">
        <a href="<?php echo home_url('/user-rating-dashboard'); ?>"><img src="<?php echo home_url('/wp-content/uploads/2022/06/rating-nav-icon.png') ?>" alt=""></a>
      </li>
      <li>
        <a href="<?php echo home_url('/user-setting'); ?>"><img src="<?php echo home_url('/wp-content/uploads/2022/06/setting-nav-icon.png') ?>" alt=""></a>
      </li>
    </ul>
  </aside>
